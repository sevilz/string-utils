"""
Django settings for stringutils project.
...
SECRET_KEY = 'y@el^wfdcyac+ubyn1!(j&0$%&8v&&hy4b!#lovyil+m!f*k5c'
...
WSGI_APPLICATION = 'stringutils.wsgi.application'
